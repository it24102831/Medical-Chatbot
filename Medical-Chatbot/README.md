...
This project is a Retrieval-Augmented Generation (RAG) based medical chatbot. It leverages a set of medical documents to provide answers to user questions. The application is built with Python, Flask, LangChain, and uses Pinecone as the vector database.
...
2.  **Retrieval and Generation (Inference)**:
    ...
    -   The user's question and the retrieved context are passed to a Large Language Model (LLM) via OpenRouter.
